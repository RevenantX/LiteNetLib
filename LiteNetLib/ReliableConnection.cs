...
namespace LiteNetLib
{
    public class ReliableConnection
    {
        ...
        //Socket constructor
        public ReliableConnection(NetSocket socket, EndPoint remoteEndPoint)
        {
            _socket = socket;
        ...
        public void Update(int deltaTime)
        {
            ...
            if (currentMaxSend > 0)
            {
                ...
                while (_sentQueue.Count > 0 && currentSended < currentMaxSend)
                {
                    ...
                    if (packet.property == PacketProperty.Reliable)
                    {
                        _pendingAckPackets.Add(packet.sequence, packet);
                    ...
                    {
                        _pendingAckReliableInOrderPackets.Add(packet.sequence, packet);
